...
#define SD_CS_LOW()			HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_RESET)
#define SD_CS_HIGH()		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, GPIO_PIN_SET)
...
static uint8_t SD_SendCmd(uint8_t cmd, uint32_t arg, uint8_t crc){
	...
	//Wait resp
	do{
		HAL_SPI_Receive(&hspi2, &resp, 1, HAL_MAX_DELAY);
